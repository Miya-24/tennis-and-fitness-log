# 🎾 Tennis & Fitness Evolution Log

テニスのスキルアップと、理想の身体（目標 58kg）を手に入れるための管理リポジトリです。
...
### 1. Tennis
- [ ] ダブルスでのボレーの精度向上
- [ ] 白石コーチのアドバイスを練習に反映させる
- [ ] 中級以上のトーナメントで安定して勝ち進む

### 2. Fitness & Training
- [ ] 体重 58kg 達成（マイナス 7kg）
- [ ] スクワットのフォーム安定と重量アップ
- [ ] ケーブルウッドチョップによる体幹（回旋動作）の強化
